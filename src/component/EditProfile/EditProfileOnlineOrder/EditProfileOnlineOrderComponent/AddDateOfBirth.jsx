  ...
  return (
    <div>
      <Button
        ...
        startIcon={
          Boolean(Profile.DateOfBirth) ? (
            <MdEdit color="#707070" size={20} />
          ) : (
            <AiFillPlusCircle color="#707070" size={20} />
          )
        }
      >
      ...
      <Dialog
        open={Open}
        onClose={handleClose}
        className={classes.addDateOfBirthPopup}
      >
        <div className="container-fluid py-4 px-4">
          <div className="row">
            <div className="col-12 text-end">
              <IconButton aria-label="closebutton" onClick={handleClose}>

  ...
  return (
    <div>
      ...
      <Dialog
        open={Open}
        onClose={handleClose}
        className={classes.medicalCardDetail_dialog}
      >
        <div className="container-fluid py-4 px-4">
          <div className="row">
            ...
            <h2 className="medicalCard_heading">
              Add Medical Card Informations
            </h2>
          </div>
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="row">
              <div className="col-12">
                <label htmlFor="medical card number">
                  Medical Card Number*
                </label>
              </div>
            ...
            <div className="row mt-4">
              <div className="col-12 mt-2">
                <label htmlFor="MedicalCardState">
                  {"Medical Card State*"}
                </label>
              </div>
              <div className="col-12 mt-2">

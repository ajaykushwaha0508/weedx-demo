                                        ...
                                        <span >
                                            <Link href="/">
                                                <Image
                                                    ...
                                                    priority
                                                    src="https://selnew-selnoxnew.s3.amazonaws.com/media/BlankImage/weedx.webp"
                                                    alt="WeedX.io logo"
                                                    title="WeedX.io logo"
                                                    width={50}
                                                    height={50}
                                    ...
                                    <div className="col-9" ref={profileRef}>
                                        ...
                                        <section className={'image_name_section'}>
                                            ...
                                            <div className={clases.slider_image_profile_names_conatiner}>
                                                <p className={`${clases.slider_image_name_heading} ellipsis`} onClick={Redirect}>{state.Profile.username}</p>
                                            </div>
                                        </section>

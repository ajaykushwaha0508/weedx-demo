...
const LinkedInIcon = React.lazy(() =>
  import("react-icons/bs").then((module) => ({ default: module.BsLinkedin }))
);
    ...
    <footer className="mt-4">
      <div className="container px-0">
        <div className={"footer_main_div_display"}>
          ...
          <h3
            className={"footer_sub_heading"}
          >{`Your Ultimate Cannabis Guide. Discover Dispensaries, Delivery Services, Brands, and Comprehensive Product Information Near You`}</h3>
          <div className={`row ${"main_content_logo"}`}>
            <div className={"footer_logo_container"}>
              <div className={"footerLogo"}>
                <Image
                  ...
                  src={
                    "https://selnew-selnoxnew.s3.amazonaws.com/media/BlankImage/weedx.webp"
                  }
                  alt="weedx.io logo"
                  title="weedx.io logo"
                />
              ...
              <div className={"contact_info"}>
                <div className={"Footer_Left_side_menu"}>
                  ...
                  <span
                    className={"footer_middle_icons_text"}
                  >{`United States , Canada`}</span>
                </div>
                <div className={"Footer_Left_side_menu"}>
                ...
                <div className={"Footer_Left_side_menu"}>
                  <Link
                    href={
                      "http://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&href=info@weedx.io"
                    }
                  >
                    {" "}
            ...
            <div className={"footer_list"}>
              <div className={"footer_main_list"}>
                ...
                <Link href={"/aboutus"}>
                  <span
                    className={`${"footer_li"} text-capitalize ellipsis`}
                  >{`About Us`}</span>
                </Link>
                <Link href={"/faq"}>
                  <span className={`${"footer_li"} ellipsis`}>{`FAQ's`}</span>
                </Link>
                ...
                <Link href={`/blogs`}>
                  <span className={`${"footer_li"} text-capitalize ellipsis`}>
                    {`Blogs`}{" "}
                  </span>{" "}
                </Link>
              </div>
                  ...
                  if (index >= 4) {
                    return (
                      <Link
                        ...
                        key={index}
                        className={morelist ? "" : "showmoreList"}
                      >
                        <span
                          className={`${"footer_li"} textCapitalize ellipsis`}
                        >
                          {ele.name}
                        </span>
                      </Link>
            ...
            <div className={"footer_list"}>
              <div className={"footer_main_list"}>
                ...
                <Link href={`http://cannabaze.com/signup`}>
                  <span className={`${"footer_li"} ellipsis`}>
                ...
                <Link href={`http://cannabaze.com/signup`}>
                  <span className={`${"footer_li"} ellipsis`}>
                    <span className="text-capitalize">{`Add Brand`}</span>
                  </span>
                </Link>
                <Link href={`http://cannabaze.com/signup`}>
                  <span className={`${"footer_li"} ellipsis`}>
                    <span className="text-capitalize">{`Add Delivery`}</span>
                  </span>
                </Link>
                <Link href={`/add-business`}>
                  <span className={`${"footer_li"} ellipsis`}>
                    <span className="text-capitalize">{`Add Business`}</span>
                  </span>
                </Link>
                <Link href={`/advertise`}>
                  <span className={`${"footer_li"} ellipsis`}>
                    <span className="text-capitalize">{`Advertise`}</span>
                  </span>
                </Link>
              </div>
            </div>
          </div>
          <div className={"bottom_white_line"}></div>
              ...
              <p className="px-0">
                ...
                <span>
                  <Link
                    aria-label="Visit Weedx LinkedIn page"
                    target="_blank"
                    href={"http://www.instagram.com/weedx_io"}
                  >
                ...
                <span>
                  <Link
                    aria-label="Visit Weedx LinkedIn page"
                    target="_blank"
                    href={"http://twitter.com/Weedx_io"}
                  >

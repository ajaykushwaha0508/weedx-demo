                                        ...
                                        <div className="EmtyCard_container">
                                            <div className="row">
                                                <div className="col-12 image_container">
                                                    ...
                                                    <p className="height_empty_div_paragraph ">{`Apologies, this page is currently empty, but stay tuned as we're working to bring you exciting products soon!`}</p><br/>
                                                    <p className=" height_empty_div_paragraph "> {`your weed today.`}</p>

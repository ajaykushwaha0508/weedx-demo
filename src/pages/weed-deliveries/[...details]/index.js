...
export default function DispensoriesDetails(props) {
  ...
  var { id, storeData, product, allProduct, storeDelivery, review } =
    props.params;
  let tab =
      ...
      answer: (
        <span
          dangerouslySetInnerHTML={{
            __html: ` ${
              Despen[0].Store_Name
            } delivers to <a target="#" href="http://www.google.com/maps/search/?api=1&query=${encodeURIComponent(
        ...
        <div className="">
          ...
          {tab === "deals" && (
            <div className={newclases.noReview}>
              ...
              <p className={`${newclases.noreview_description} w-lg-50`}>
    ...
    return [
      {
        ...
        delivery: dispensariesResponse.data,
        review: review.data,
      },
    ];
  } catch (error) {

...
export const getServerSideProps = async (context) => {
    ...
    if (isDirectHit || isFromGoogle) {
        ...
        const createurl = Boolean(route) ? `http://www.weedx.io/weed-deliveries/in/${modifystr(country1)}/${modifystr(state)}/${modifystr(city)}/${modifystr(route)}`
            : Boolean(city) ? `http://www.weedx.io/weed-deliveries/in/${modifystr(country1)}/${modifystr(state)}/${modifystr(city)}`
                : Boolean(state) ? `http://www.weedx.io/weed-deliveries/in/${modifystr(country1)}/${modifystr(state)}`
                    : Boolean(country1) && `http://www.weedx.io/weed-deliveries/in/${modifystr(country1)}`

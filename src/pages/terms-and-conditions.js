      ...
      <div className={Styled.term_condition}>
        ...
        <div className="container-fluid">
          <div className={Styled.tc_hero}>
            <h1 className={Styled.page_heading}>{`  Website Terms and Conditions`}  </h1>
          </div>
          ...
          <div className={`col-md-7 ${Styled.tc_main_centent}`}> 
              <ol ref={ref} >
                <li id='acceptance_of_terms'>
                  <span className={Styled.question}>{`Acceptance of Terms`}</span>
                ...
                <li id='eligibility_to_use_website'>
                  <span className={Styled.question}>{`Eligibility to Use Website`}</span>
                  <span className={Styled.answer}>
                ...
                <li id='verification_of_age'>
                  <span className={Styled.question}>{`Verification of Age`}</span>
                  <span className={Styled.answer}>
                ...
                <li id='privacy_policy'>
                  <span className={Styled.question}>{`Privacy Policy`}</span>
                  <span className={Styled.answer}>{`Your use of the website is also governed by our `}<Link href={'/privacy-policy'}>{`Privacy Policy`}</Link>{`, 
                ...
                <li id='user_registration'>
                  <span className={Styled.question}>{`User Registration`}</span>
                  <span className={Styled.answer}>
                ...
                <li id='online_ordering_&_Delivery_Services'>
                  <span className={Styled.question}> {`Online Ordering and Delivery Services`} </span>
                  <span className={Styled.answer}>
                ...
                <li id='dispensary_and_retailer_listings'>
                  <span className={Styled.question}>  {`Dispensary and Retailer Listings`} </span>
                  <span className={Styled.answer}>
                ...
                <li id='compliance_with_local_laws'>
                  <span className={Styled.question}> {`Compliance with Local Laws`}</span>
                  <span className={Styled.answer}>
                ...
                <li id='intellectual_property'>
                  <span className={Styled.question}> {`Intellectual Property `}</span>
                  <span className={Styled.answer}>
                ...
                <li id='limitation_of_liability'>
                  <span className={Styled.question}> {` Limitation of Liability`}</span>
                  <span className={Styled.answer}>
                ...
                <li id='changes_to_terms'>
                  <span className={Styled.question}> {`Changes to Terms`}</span>
                  <span className={Styled.answer}>
                ...
                <li id='termination'>
                  <span className={Styled.question} >{`Termination`}</span>
                  <span className={Styled.answer}>

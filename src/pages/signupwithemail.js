        ...
        <div className="row">
          ...
          <div className="col-lg-12 mt-1 ">
            <TextField
              ...
              helperText={React.useMemo(
                () => method.errors?.email?.message || dulicate?.email,
                [method.errors, dulicate]
              )}
        ...
        <div className="rowmt-3">
          ...
          <div className="col-lg-12 mt-1 ">
            <TextField
              ...
              error={
                Boolean(method.errors?.Name) || Boolean(dulicate?.username)
              }
            />
          </div>
        </div>
            ...
            <TextField
              ...
              inputRef={method.register({
                ...
                pattern: {
                  ...
                  message:
                    "At least one uppercase,lowercase,number,one special character",
                },
              })}
